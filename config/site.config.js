...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '13510543077@163.com',
  ...
  protectedRoutes: ['/Document/u-need-a-password', '/🥟 Some test files/Protected route'],
